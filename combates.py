...
def combate1():
    ...
    fundo = GameImage("map (3).png")
    perdeu = GameImage("game_over_solaris (1).png")

    Alice = Sprite("personagem_combate_Alice.png")
    Alice.x, Alice.y = 250, 135

    Pablo = Sprite("personagem_combate_Pablo.png")
    Pablo.x, Pablo.y = 200, 80
    ...
    musicacombate = Sound("musicacombate.ogg")
    musicacombate.set_volume(25)
    musicacombate.stop()
    ...
    Info_personagem_Pablo_morte = Sprite("ver8_1_Pablo.png")
    Info_personagem_Pablo_morte.x, Info_personagem_Pablo_morte.y = Info_personagem_Pablo.x, Info_personagem_Pablo.y
    ...
    def Ocultista_info():
        dano_ataque_Ocultista = 11
        dano_habilidade_Ocultista = 16
        vida_Ocultista = 150
    ...
    def Texto_esquiva(personagem):
        janela.draw_text(f"{personagem} Esquivou do Ataque", 510, 351, size=40, color=(255, 255, 255), font_name="m6x11")


    def Texto_dano_inimigo(personagem, dano_ataque):
        janela.draw_text(f"{personagem} Sofreu {dano_ataque} de Dano", 505, 351, size=40, color=(255, 255, 255),
                         font_name="m6x11")
    ...
    def Texto_habilidades_Alice(dano_habilidade_dano_Alice, gasto_energia_habilidade_dano_Alice, rec_habilidade_vida_Alice,
                                gasto_energia_habilidade_vida_Alice):
    ...
    def Texto_habilidades_Pablo(dano_habilidade_dano_Pablo, gasto_energia_habilidade_dano_Pablo, rec_habilidade_vida_Pablo,
                                gasto_energia_habilidade_vida_Pablo):
    ...
    def Combate(vida_atual_Alice, energia_atual_Alice, vida_atual_Pablo, energia_atual_Pablo):
        ...
        dano_habilidade_Alice, gasto_habilidade_dano_Alice, critico_Habilidade = Alice_habilidade_dano(buff_habilidade_dano,
                                                                                                       buff_habilidade_dano_gasto,
                                                                                                       buff_critico_habilidade)
        ...
        dano_Cruzado_Pablo, rec_energia_Cruzado_Pablo, critico_Cruzado = Pablo_Cruzado(buff_Investida, buff_rec_energia1,
                                                                                       buff_critico_Investida)
        dano_Gancho_Pablo, rec_energia_Gancho_Pablo, critico_Gancho = Pablo_Gancho(buff_QuebraNoz, buff_rec_energia2,
                                                                                   buff_critico_QuebraNoz)
        dano_habilidade_Pablo, gasto_habilidade_dano_Pablo, critico_Habilidade = Pablo_habilidade_dano(buff_habilidade_dano,
                                                                                                       buff_habilidade_dano_gasto,
                                                                                                       buff_critico_habilidade)
        ...
        while True:
            ...
            if cont_dano_Alice > 0:
                Texto_dano_inimigo("Alice", cont_dano_Alice)

            if cont_dano_Pablo > 0:
                Texto_dano_inimigo("Pablo", cont_dano_Pablo)
            ...
            if vida_atual_Pablo <= 0:
                if turno == "Pablo":
                    cont_morte_Pablo += 1
                    turno = "inimigo"
                Info_personagem_Pablo_morte.draw()
            ...
            if turno == "inimigo":
                ...
                if personagem_sofrer == "Alice" and vida_atual_Alice > 0:
                    ...
                    if esquivou == False:
                        if tipo_dano == "ataque":
                            cont_dano_Alice = dano_ataque_inimigo
                            vida_atual_Alice -= dano_ataque_inimigo

                        else:
                            cont_dano_Alice = dano_habilidade_inimigo
                ...
                if personagem_sofrer == "Pablo" and vida_atual_Pablo > 0:
                    ...
                    if esquivou == False:
                        if tipo_dano == "ataque":
                            cont_dano_Pablo = dano_ataque_inimigo
                            vida_atual_Pablo -= dano_ataque_inimigo

                        else:
                            cont_dano_Pablo = dano_habilidade_inimigo
...
def combate2():
    ...
    Pablo = Sprite("personagem_combate_Pablo.png")
    Pablo.x, Pablo.y = 100, 80

    Ocultista = Sprite("wizard_boss.png", 4)
    Ocultista.x, Ocultista.y = 580, 110

    Ocultista.set_total_duration(1000)

    musicacombate = Sound("musicacombate.ogg")
    musicacombate.set_volume(50)
    musicacombate.stop()
    musicacombate.loop = True
    musicacombate.play()
...
def combate3():
    ...
    Ocultista = Sprite("idle_death8.png", 8)
    Ocultista.x, Ocultista.y = 530, 80
